							...
							<table class="table table-hover text-nowrap">
								...
								<tbody>
									...
									<tr>
										...
										<td>0</td>
										<td>
											<a href="{{route('admin.tag.show', $tag->id)}}" class="mr-1"><i class="nav-icon far fa-eye1"></i>show</a>
										</td>
										<td>
											<a href="{{route('admin.tag.edit',$tag->id)}}" class="mr-1 text-success"><i class="nav-icon far fa-pen"></i>edit</a>
										</td>
										<td>
